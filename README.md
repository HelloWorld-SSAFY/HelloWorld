...
**HelloWorld**는 임산부와 가족이 함께하는 임신 여정을 기록하고 공유하는 **종합 케어 서비스**입니다.

산모와 보호자가 각자의 시선으로 일기를 작성하고, 초음파·음식·일상 사진을 **안전하게 저장 및 공유**할 수 있습니다.  
**주차별/상태별 맞춤 추천**을 통해 태아 발달 정보, 건강 관리 가이드, 체크리스트를 제공하며, 갤럭시 워치와 연동하여 산모의 위험을 감지할 수 있습니다.
  
초음파 이미지를 **DALL·E-3 캐리커처**로 변환해 특별한 추억을 남길 수 있습니다.

모든 미디어는 **S3 Presigned URL**을 통해 안전하게 업로드·다운로드되며, 가족 간 실시간 동기화로 소중한 순간을 함께 나눕니다.
